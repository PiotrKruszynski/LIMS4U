"""
Django settings for LIMS4U project.
...
SECRET_KEY = 'django-insecure-nt+ox3^bm3kd=$r#m3u#)ci#o6^*@g8$qt!#kw0r(jhy^zl8x5'
...
WSGI_APPLICATION = 'LIMS4U.wsgi.application'
